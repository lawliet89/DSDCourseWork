...
# data
add_parameter FLASH_MEMORY_DATA_WIDTH int 8
set_parameter_property FLASH_MEMORY_DATA_WIDTH DISPLAY_NAME FLASH_MEMORY_DATA_WIDTH
set_parameter_property FLASH_MEMORY_DATA_WIDTH UNITS None
set_parameter_property FLASH_MEMORY_DATA_WIDTH AFFECTS_PORT_WIDTHS true
# | 
# +-----------------------------------
